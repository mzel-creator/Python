...
stroky = int(input("Введите количество строк и столбцов матрицы: "))
ctolbcy = stroky

matrix_1 = Matrix([[i * j  for j in range(stroky)] for i in range(ctolbcy)])
matrix_2 = Matrix([[i * j  for j in range(stroky)] for i in range(ctolbcy)])
